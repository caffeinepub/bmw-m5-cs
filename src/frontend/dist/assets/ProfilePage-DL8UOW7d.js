import { c as createLucideIcon, u as useAuth, r as reactExports, j as jsxRuntimeExports, m as motion, X, U as User, A as AnimatePresence, L as LogOut, S as ShieldCheck } from "./index-CFGClM9r.js";
import { u as useActor, M as Mail, C as Calendar, L as Lock, b as CircleAlert, a as Clock, E as Eye } from "./useActor-DS99H6IV.js";
import { C as CircleCheckBig } from "./circle-check-big-Hu2mhAni.js";
  ...
  reactExports.useEffect(() => {
    ...
    if (isAdmin) {
      Promise.all([actor.getAllBookings(), actor.getAllComments()]).then(([bk, cm]) => {
        ...
        setPendingCount(
          bk.filter((b) => b.status === "pending").length
        );
