import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, m as motion, A as AnimatePresence } from "./index-CFGClM9r.js";
import { E as ExternalLink } from "./external-link-D1BHkTnc.js";
import { C as ChevronRight } from "./chevron-right-NzRH_4wf.js";
/**
...
function TrackSection() {
  ...
  const [hoveredThumb, setHoveredThumb] = reactExports.useState(null);
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    style: {
                      ...
                      background: "linear-gradient(135deg, #FFFFFF 0%, #20E0E6 50%, #FFFFFF 100%)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[1fr_340px] gap-6 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { aspectRatio: "16/9" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "img",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: {
                            background: "linear-gradient(0deg, rgba(7,9,13,0.95) 0%, rgba(7,9,13,0.4) 40%, rgba(7,9,13,0.1) 100%)"
                          }
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-6", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-4", children: current.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                  ...
                  VIDEOS.map((video, idx) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.button,
                      {
                        ...
                        style: {
                          border: isActive ? `1px solid ${video.accent}60` : "1px solid rgba(255,255,255,0.07)",
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { aspectRatio: "16/9" }, children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "absolute inset-0",
                              style: {
                                background: "linear-gradient(0deg, rgba(7,9,13,0.85) 0%, rgba(7,9,13,0.3) 60%, transparent 100%)"
                              }
                            }
                          ),
