            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(0deg, rgba(11,15,20,0.9) 0%, rgba(11,15,20,0.3) 35%, transparent 60%)",
                  }}
                />
              ...
              {galleryImages.map((gimg, i) => (
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      i === current
                        ? "0 0 8px #20E0E6, 0 0 16px rgba(32,224,230,0.4)"
                        : "none",
                  }}
