...
const AUDIO_SRC =
  "/assets/uploads/bmw_m5_f90_stage_3_ib_performance_-_fire_exhaust_dyno_insane_-_horsepower_lovers_youtube-019d2a87-823b-7489-96db-dc6c64c07fb7-1.mp3";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        >
          {isRunning
            ? "BMW M5 F90 Stage 3 · IB Performance · Live Audio"
            : "Click to hear the real S63 V8"}
        </p>
      </div>
    </section>
  );
